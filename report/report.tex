...
We will clear the database file every time the DSL gets executed.
This is not very feasible in real life, of course. 
Although, it will illustrate the solution in a clear fashion and decreases the work to do.
...
The reason for this is because SQL scripts seem difficult to do, as discussed earlier. %TODO link?
